...
SEIRD_model_beta_alpha_gamma_eta_u0 = "
functions {
...
function main_prog()
    ...
    #Aprender beta, aplha, gamma e eta
    seird_data = Dict("T" => T, "u0" => u0, "t0" => 0.0, "ts" => t, "D_obs" => D_obs, "N" => N)

    # Keep tmpdir across multiple runs to prevent re-compilation
    tmpdir = joinpath(@__DIR__, "tmp")

    sm = SampleModel("sm_seird_beta_alpha_gamma_eta_u0", SEIRD_model_beta_alpha_gamma_eta_u0, tmpdir)
    ...
    if success(rc)
        ...
        StatsPlots.savefig("MCMC_4params_u0.png")
    end
end
